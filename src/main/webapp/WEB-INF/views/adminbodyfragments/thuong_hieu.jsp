...
<script type="text/javascript" src="admin/js/ajax/ajax_thuong_hieu.js"></script>
<div id="pageThuongHieu">
    <%-- sub window--%>
                    ...
                    <div class="col-12">
                                    ...
                                    <div class="card card-default col-12" style="margin-bottom: 0px;">
                                        <div class="card-header">
                                            <h2 class="card-title font-weight-bold"><font
                                                    ...
                                                    style="vertical-align: inherit;">Chi tiết thương hiệu</font></font></h2>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12"
                                                    ...
                                                    <div class="form-group">
                                                        <label><font style="vertical-align: inherit;"><font
                                                                style="vertical-align: inherit;">Tên thương hiệu</font></font></label>
                        ...
                        <div class="row">
                            <div class="form-group"
                                ...
                                <button id="btnAddNewTH" data-bind="click: saveNewTH.bind(this)" style="display: none"
                                        class="btn btn-success">Thêm mới
                                </button>
                                <button id="btnUpdateNewTH" data-bind="click: updateTH.bind(this)" class="btn btn-success " style="display: none" >Lưu Lại
                                </button>
                            </div>
                        </div>
                        <!-- /.nav-tabs-custom -->
            ...
            <div class="card" style="padding: 15px">
                <div class="card-header row justify-content-around"
                    ...
                    <div class="card-tools col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mb-2 " style="margin-right: 0px">
                        <div class="input-group input-group-sm" style="display: flex">
                            <input id="inputSearchTH" data-bind="value : keywordSearchTH, valueUpdate: 'afterkeydown'" style="width: auto" type="text" name="table_search"
                                   class="form-control float-right"
                                   placeholder="Search">

                            <div class="input-group-append">
                                <button  data-bind="click: btnSearchNameTH.bind(this,keywordSearchTH())" class="btn btn-default"><i
                ...
                <div class="row pb-1">
                    <div class="input-group-append col-12">
                        <button class="btn btn-success btn-show-add-course" data-bind="click: openNewTH.bind(this)">
                ...
                <div class="card-body table-responsive p-0" style="height: auto;">
                    <table class="table table-head-fixed table-hover">
                        ...
                        <tbody data-bind="foreach: listThuongHieu" id="tableShowAllcourse">
                        <tr data-bind="attr:{'id':'attr'+id}"
                            ...
                            <td>
                                <div class="mailbox-controls">
                                    <!-- Check all button -->
                                    <div class="btn-group">
                                        <button title="xem" data-bind="click: $parent.showDetailThuongHieu.bind(this,id)"
                                                type="button"
